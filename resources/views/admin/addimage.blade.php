                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    @if ($errors->any())
                                        ...
                                        @endif
                                    <form method="post" action="{{ url('/admin/imagestor') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            <select name="catid" class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="{{$catdata->id}}">{{$catdata->catname}}</option>
                                                @endforeach
                                                </select>     
                                            </div>
                                            <label class=" my-2" for="my-input">Image</label>
