                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <a href="{{url('/admin/addimage')}}" class="btn btn-primary">Add Image</a>
                                    </div>
                                    <!-- table hover -->
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="image" src="{{asset('images/'.$data->image)}}" alt="image">
                                                    </td>
                                                    <td>{{ $data->catname }}</td>
                                                    <td>
                                                        <a href="{{ '/admin/delletimage/'.$data->id }}" onclick="return confirm('Are you sure to delete')" class="btn btn-danger my-1">Delete</a>
